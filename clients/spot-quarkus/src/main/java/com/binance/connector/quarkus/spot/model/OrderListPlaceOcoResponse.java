...
public class OrderListPlaceOcoResponse extends BaseDTO {
    ...
    public OrderListPlaceOcoResponse id( String id) {
        this.id = id;
        return this;
    }
    ...
    public OrderListPlaceOcoResponse status( Long status) {
        this.status = status;
        return this;
    }
    ...
    public OrderListPlaceOcoResponse result(
             OrderListPlaceOcoResponseResult result) {
        this.result = result;
        return this;
    }
    ...
    public void setResult( OrderListPlaceOcoResponseResult result) {
        this.result = result;
    }
    ...
    public OrderListPlaceOcoResponse addRateLimitsItem(RateLimits rateLimitsItem) {
