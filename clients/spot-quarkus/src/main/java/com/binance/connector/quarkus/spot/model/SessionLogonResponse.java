...
public class SessionLogonResponse extends BaseDTO {
    ...
    public SessionLogonResponse id( String id) {
        this.id = id;
        return this;
    }
    ...
    public SessionLogonResponse status( Long status) {
        this.status = status;
        return this;
    }
    ...
    public SessionLogonResponse result(
             SessionLogonResponseResult result) {
        this.result = result;
        return this;
    }
    ...
    public void setResult( SessionLogonResponseResult result) {
        this.result = result;
    }
    ...
    public String toString() {
        ...
        sb.append("class SessionLogonResponse {\n");
    ...
    public String toUrlQueryString() {
        ...
        SessionLogonResponseResult resultValue = getResult();
        if (resultValue != null) {
