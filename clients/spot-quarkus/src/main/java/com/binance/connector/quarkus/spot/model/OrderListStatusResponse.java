...
public class OrderListStatusResponse extends BaseDTO {
    ...
    public OrderListStatusResponse id(@jakarta.annotation.Nullable String id) {
        this.id = id;
        return this;
    }
    ...
    public OrderListStatusResponse status(@jakarta.annotation.Nullable Long status) {
        this.status = status;
        return this;
    }
    ...
    public boolean equals(Object o) {
        ...
        OrderListStatusResponse orderListStatusResponse = (OrderListStatusResponse) o;
        return Objects.equals(this.id, orderListStatusResponse.id)
                && Objects.equals(this.status, orderListStatusResponse.status)
                && Objects.equals(this.result, orderListStatusResponse.result)
                && Objects.equals(this.rateLimits, orderListStatusResponse.rateLimits);
    }
    ...
    public String toString() {
        ...
        sb.append("class OrderListStatusResponse {\n");
     ...
     * @throws IOException if the JSON Element is invalid with respect to OrderListStatusResponse
     */
    public static void validateJsonElement(JsonElement jsonElement) throws IOException {
        if (jsonElement == null) {
            if (!OrderListStatusResponse.openapiRequiredFields
                    .isEmpty()) { // has required fields but JSON element is null
                throw new IllegalArgumentException(
                        String.format(
                                "The required field(s) %s in OrderListStatusResponse is not found"
                                        + " in the empty JSON string",
                                OrderListStatusResponse.openapiRequiredFields.toString()));
            }
        }
        ...
        for (Map.Entry<String, JsonElement> entry : entries) {
            if (!OrderListStatusResponse.openapiFields.contains(entry.getKey())) {
                throw new IllegalArgumentException(
                        String.format(
                                "The field `%s` in the JSON string is not defined in the"
                                        + " `OrderListStatusResponse` properties. JSON: %s",
    ...
    public static class CustomTypeAdapterFactory implements TypeAdapterFactory {
        ...
        public <T> TypeAdapter<T> create(Gson gson, TypeToken<T> type) {
            if (!OrderListStatusResponse.class.isAssignableFrom(type.getRawType())) {
                return null; // this class only serializes 'OrderListStatusResponse' and its
                // subtypes
            }
            final TypeAdapter<JsonElement> elementAdapter = gson.getAdapter(JsonElement.class);
            final TypeAdapter<OrderListStatusResponse> thisAdapter =
                    gson.getDelegateAdapter(this, TypeToken.get(OrderListStatusResponse.class));

            return (TypeAdapter<T>)
                    new TypeAdapter<OrderListStatusResponse>() {
                        @Override
                        public void write(JsonWriter out, OrderListStatusResponse value)
                                throws IOException {
                        ...
                        @Override
                        public OrderListStatusResponse read(JsonReader in) throws IOException {
    ...
    /**
     * Create an instance of OrderListStatusResponse given an JSON string
     *
     * @param jsonString JSON string
     * @return An instance of OrderListStatusResponse
     * @throws IOException if the JSON string is invalid with respect to OrderListStatusResponse
     */
    public static OrderListStatusResponse fromJson(String jsonString) throws IOException {
        return JSON.getGson().fromJson(jsonString, OrderListStatusResponse.class);
    }

    /**
     * Convert an instance of OrderListStatusResponse to an JSON string
     *
     * @return JSON string
     */
