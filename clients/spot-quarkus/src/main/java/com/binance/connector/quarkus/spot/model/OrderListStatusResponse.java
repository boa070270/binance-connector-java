...
public class OrderListStatusResponse extends BaseDTO {
    ...
    public OrderListStatusResponse id( String id) {
        this.id = id;
        return this;
    }
    ...
    public OrderListStatusResponse status( Long status) {
        this.status = status;
        return this;
    }
    ...
    public OrderListStatusResponse result(
             AllOrderListsResponseResultInner result) {
        this.result = result;
        return this;
    }
    ...
    public void setResult( AllOrderListsResponseResultInner result) {
        this.result = result;
    }
