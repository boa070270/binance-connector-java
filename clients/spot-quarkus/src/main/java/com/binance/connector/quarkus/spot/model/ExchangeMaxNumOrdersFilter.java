...
public class ExchangeMaxNumOrdersFilter extends BaseDTO {
    ...
    @JsonProperty(SERIALIZED_NAME_MAX_NUM_ORDERS)
    
    private Long maxNumOrders;

    public ExchangeMaxNumOrdersFilter() {}

    public ExchangeMaxNumOrdersFilter filterType( String filterType) {
    ...
    public ExchangeMaxNumOrdersFilter maxNumOrders( Long maxNumOrders) {
