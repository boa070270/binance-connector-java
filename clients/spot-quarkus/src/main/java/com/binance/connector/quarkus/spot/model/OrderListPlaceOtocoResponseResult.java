...
public class OrderListPlaceOtocoResponseResult extends BaseDTO {
    ...
    private List<OrderListPlaceOtocoResponseResultOrdersInner> orders;

    public static final String SERIALIZED_NAME_ORDER_REPORTS = "orderReports";

    @JsonProperty(SERIALIZED_NAME_ORDER_REPORTS)
    
    private List<OrderListPlaceOtocoResponseResultOrderReportsInner> orderReports;
    ...
    public OrderListPlaceOtocoResponseResult symbol( String symbol) {
        this.symbol = symbol;
        return this;
    }
    ...
    public OrderListPlaceOtocoResponseResult orders(
                    ...
                    List<OrderListPlaceOtocoResponseResultOrdersInner> orders) {
        this.orders = orders;
        return this;
    }
    ...
    public List<OrderListPlaceOtocoResponseResultOrdersInner> getOrders() {
        return orders;
    }
    ...
    public OrderListPlaceOtocoResponseResult orderReports(
                    ...
                    List<OrderListPlaceOtocoResponseResultOrderReportsInner> orderReports) {
    ...
    public List<OrderListPlaceOtocoResponseResultOrderReportsInner> getOrderReports() {
        return orderReports;
    }
    ...
    public String toUrlQueryString() {
        ...
        List<OrderListPlaceOtocoResponseResultOrdersInner> ordersValue = getOrders();
        if (ordersValue != null) {
            String ordersValueAsString = Json.encode(ordersValue);
            valMap.put("orders", ordersValueAsString);
        }
        List<OrderListPlaceOtocoResponseResultOrderReportsInner> orderReportsValue =
                getOrderReports();
