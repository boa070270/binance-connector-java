...
public class TimeResponse extends BaseDTO {
    ...
    public TimeResponse id( String id) {
        this.id = id;
        return this;
    }
    ...
    public TimeResponse status( Long status) {
        this.status = status;
        return this;
    }
    ...
    public TimeResponse result( TimeResponseResult result) {
        this.result = result;
        return this;
    }
    ...
    public void setResult( TimeResponseResult result) {
        this.result = result;
    }
