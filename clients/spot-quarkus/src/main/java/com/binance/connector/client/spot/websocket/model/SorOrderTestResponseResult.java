...
public class SorOrderTestResponseResult extends BaseDTO {
     ...
     * @throws IOException if the JSON Element is invalid with respect to SorOrderTestResponseResult
     */
    public static void validateJsonElement(JsonElement jsonElement) throws IOException {
        if (jsonElement == null) {
            if (!SorOrderTestResponseResult.openapiRequiredFields
                    .isEmpty()) { // has required fields but JSON element is null
                throw new IllegalArgumentException(
                        String.format(
                                "The required field(s) %s in SorOrderTestResponseResult is not"
                                        + " found in the empty JSON string",
                                SorOrderTestResponseResult.openapiRequiredFields.toString()));
            }
        }
        ...
        for (Map.Entry<String, JsonElement> entry : entries) {
            if (!SorOrderTestResponseResult.openapiFields.contains(entry.getKey())) {
                throw new IllegalArgumentException(
                        String.format(
                                "The field `%s` in the JSON string is not defined in the"
                                        + " `SorOrderTestResponseResult` properties. JSON: %s",
    ...
    public static class CustomTypeAdapterFactory implements TypeAdapterFactory {
        ...
        public <T> TypeAdapter<T> create(Gson gson, TypeToken<T> type) {
            if (!SorOrderTestResponseResult.class.isAssignableFrom(type.getRawType())) {
                return null; // this class only serializes 'SorOrderTestResponseResult' and its
                // subtypes
            }
            final TypeAdapter<JsonElement> elementAdapter = gson.getAdapter(JsonElement.class);
            final TypeAdapter<SorOrderTestResponseResult> thisAdapter =
                    gson.getDelegateAdapter(this, TypeToken.get(SorOrderTestResponseResult.class));

            return (TypeAdapter<T>)
                    new TypeAdapter<SorOrderTestResponseResult>() {
                        @Override
                        public void write(JsonWriter out, SorOrderTestResponseResult value)
                                throws IOException {
                        ...
                        @Override
                        public SorOrderTestResponseResult read(JsonReader in) throws IOException {
    ...
    /**
     * Create an instance of SorOrderTestResponseResult given an JSON string
     *
     * @param jsonString JSON string
     * @return An instance of SorOrderTestResponseResult
     * @throws IOException if the JSON string is invalid with respect to SorOrderTestResponseResult
     */
    public static SorOrderTestResponseResult fromJson(String jsonString) throws IOException {
        return JSON.getGson().fromJson(jsonString, SorOrderTestResponseResult.class);
    }

    /**
     * Convert an instance of SorOrderTestResponseResult to an JSON string
     *
     * @return JSON string
     */
