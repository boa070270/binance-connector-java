...
public class PingResponse extends BaseDTO {
    ...
    public PingResponse id(@jakarta.annotation.Nullable String id) {
        this.id = id;
        return this;
    }
    ...
    public PingResponse status(@jakarta.annotation.Nullable Long status) {
        this.status = status;
        return this;
    }
    ...
    public PingResponse result(@jakarta.annotation.Nullable Object result) {
        this.result = result;
        return this;
    }
    ...
    public boolean equals(Object o) {
        ...
        return Objects.equals(this.id, pingResponse.id)
                && Objects.equals(this.status, pingResponse.status)
                && Objects.equals(this.result, pingResponse.result)
                && Objects.equals(this.rateLimits, pingResponse.rateLimits);
    }
    ...
    public static void validateJsonElement(JsonElement jsonElement) throws IOException {
        if (jsonElement == null) {
            if (!PingResponse.openapiRequiredFields
                    .isEmpty()) { // has required fields but JSON element is null
                throw new IllegalArgumentException(
                        String.format(
                                "The required field(s) %s in PingResponse is not found in the empty"
                                        + " JSON string",
                                PingResponse.openapiRequiredFields.toString()));
            }
        }
                ...
                throw new IllegalArgumentException(
                        String.format(
                                "The field `%s` in the JSON string is not defined in the"
                                        + " `PingResponse` properties. JSON: %s",
