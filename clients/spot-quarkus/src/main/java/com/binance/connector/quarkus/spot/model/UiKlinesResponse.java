...
public class UiKlinesResponse extends BaseDTO {
    ...
    public UiKlinesResponse id( String id) {
        this.id = id;
        return this;
    }
    ...
    public UiKlinesResponse status( Long status) {
        this.status = status;
        return this;
    }
    ...
    public UiKlinesResponse result( List<UiKlinesItem> result) {
        this.result = result;
        return this;
    }
    ...
    public void setResult( List<UiKlinesItem> result) {
        this.result = result;
    }
