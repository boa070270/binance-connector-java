...
public class UiKlinesResponse extends BaseDTO {
    ...
    @jakarta.annotation.Nullable
    private List<UiKlinesItem> result;
    ...
    public UiKlinesResponse id(@jakarta.annotation.Nullable String id) {
        this.id = id;
        return this;
    }
    ...
    public UiKlinesResponse status(@jakarta.annotation.Nullable Long status) {
        this.status = status;
        return this;
    }
    ...
    public UiKlinesResponse result(@jakarta.annotation.Nullable List<UiKlinesItem> result) {
        this.result = result;
        return this;
    }

    public UiKlinesResponse addResultItem(UiKlinesItem resultItem) {
        if (this.result == null) {
    ...
    @jakarta.annotation.Nullable
    @Valid
    public List<UiKlinesItem> getResult() {
        return result;
    }

    public void setResult(@jakarta.annotation.Nullable List<UiKlinesItem> result) {
        this.result = result;
    }
    ...
    public boolean equals(Object o) {
        ...
        UiKlinesResponse uiKlinesResponse = (UiKlinesResponse) o;
        return Objects.equals(this.id, uiKlinesResponse.id)
                && Objects.equals(this.status, uiKlinesResponse.status)
                && Objects.equals(this.result, uiKlinesResponse.result)
                && Objects.equals(this.rateLimits, uiKlinesResponse.rateLimits);
    }
    ...
    public String toString() {
        ...
        sb.append("class UiKlinesResponse {\n");
    ...
    public String toUrlQueryString() {
        ...
        List<UiKlinesItem> resultValue = getResult();
        if (resultValue != null) {
    ...
    public static void validateJsonElement(JsonElement jsonElement) throws IOException {
        ...
        if (jsonObj.get("result") != null
                && !jsonObj.get("result").isJsonNull()
                && !jsonObj.get("result").isJsonArray()) {
            throw new IllegalArgumentException(
                    String.format(
    ...
    public static class CustomTypeAdapterFactory implements TypeAdapterFactory {
        ...
        public <T> TypeAdapter<T> create(Gson gson, TypeToken<T> type) {
            if (!UiKlinesResponse.class.isAssignableFrom(type.getRawType())) {
                return null; // this class only serializes 'UiKlinesResponse' and its subtypes
            }
            final TypeAdapter<JsonElement> elementAdapter = gson.getAdapter(JsonElement.class);
            final TypeAdapter<UiKlinesResponse> thisAdapter =
                    gson.getDelegateAdapter(this, TypeToken.get(UiKlinesResponse.class));

            return (TypeAdapter<T>)
                    new TypeAdapter<UiKlinesResponse>() {
                        @Override
                        ...
                        @Override
                        public UiKlinesResponse read(JsonReader in) throws IOException {
    ...
    /**
     * Create an instance of UiKlinesResponse given an JSON string
     *
     * @param jsonString JSON string
     * @return An instance of UiKlinesResponse
     * @throws IOException if the JSON string is invalid with respect to UiKlinesResponse
     */
    public static UiKlinesResponse fromJson(String jsonString) throws IOException {
        return JSON.getGson().fromJson(jsonString, UiKlinesResponse.class);
    }

    /**
     * Convert an instance of UiKlinesResponse to an JSON string
     *
     * @return JSON string
     */
