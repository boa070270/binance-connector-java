...
public class OrderListPlaceOtocoResponse extends BaseDTO {
    ...
    public OrderListPlaceOtocoResponse id( String id) {
        this.id = id;
        return this;
    }
    ...
    public OrderListPlaceOtocoResponse status( Long status) {
        this.status = status;
        return this;
    }
    ...
    public OrderListPlaceOtocoResponse result(
             OrderListPlaceOtocoResponseResult result) {
        this.result = result;
        return this;
    }
    ...
    public void setResult( OrderListPlaceOtocoResponseResult result) {
        this.result = result;
    }
