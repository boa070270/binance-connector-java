...
public class AccountCommissionResponseResultDiscount extends BaseDTO {
    ...
    public AccountCommissionResponseResultDiscount() {}

    public AccountCommissionResponseResultDiscount enabledForAccount(
    ...
    public AccountCommissionResponseResultDiscount enabledForSymbol(
    ...
    public AccountCommissionResponseResultDiscount discountAsset(
    ...
    public AccountCommissionResponseResultDiscount discount(
    ...
    public String toString() {
        ...
        sb.append("class AccountCommissionResponseResultDiscount {\n");
    ...
    public static void validateJsonElement(JsonElement jsonElement) throws IOException {
        if (jsonElement == null) {
            if (!AccountCommissionResponseResultDiscount.openapiRequiredFields
                    .isEmpty()) { // has required fields but JSON element is null
                throw new IllegalArgumentException(
                        String.format(
                                "The required field(s) %s in"
                                    + " AccountCommissionResponseResultDiscount is not found in the"
                                    + " empty JSON string",
                                AccountCommissionResponseResultDiscount.openapiRequiredFields
                                        .toString()));
            }
        }
        ...
        for (Map.Entry<String, JsonElement> entry : entries) {
            if (!AccountCommissionResponseResultDiscount.openapiFields.contains(entry.getKey())) {
                throw new IllegalArgumentException(
                        String.format(
                                "The field `%s` in the JSON string is not defined in the"
                                    + " `AccountCommissionResponseResultDiscount` properties. JSON:"
                                    + " %s",
    ...
    public static class CustomTypeAdapterFactory implements TypeAdapterFactory {
        ...
        public <T> TypeAdapter<T> create(Gson gson, TypeToken<T> type) {
            if (!AccountCommissionResponseResultDiscount.class.isAssignableFrom(
                    type.getRawType())) {
                return null; // this class only serializes 'AccountCommissionResponseResultDiscount'
                // and its subtypes
            }
            final TypeAdapter<JsonElement> elementAdapter = gson.getAdapter(JsonElement.class);
            final TypeAdapter<AccountCommissionResponseResultDiscount> thisAdapter =
                    gson.getDelegateAdapter(
                            this, TypeToken.get(AccountCommissionResponseResultDiscount.class));

            return (TypeAdapter<T>)
                    new TypeAdapter<AccountCommissionResponseResultDiscount>() {
                        @Override
                        public void write(
                        ...
                        @Override
                        public AccountCommissionResponseResultDiscount read(JsonReader in)
                                throws IOException {
    ...
    /**
     * Create an instance of AccountCommissionResponseResultDiscount given an JSON string
     *
     * @param jsonString JSON string
     * @return An instance of AccountCommissionResponseResultDiscount
     * @throws IOException if the JSON string is invalid with respect to
     *     AccountCommissionResponseResultDiscount
     */
    public static AccountCommissionResponseResultDiscount fromJson(String jsonString)
            throws IOException {
        return JSON.getGson().fromJson(jsonString, AccountCommissionResponseResultDiscount.class);
    }

    /**
     * Convert an instance of AccountCommissionResponseResultDiscount to an JSON string
     *
     * @return JSON string
     */
