...
public class MarketLotSizeFilter extends BaseDTO {
    ...
    public MarketLotSizeFilter filterType( String filterType) {
    ...
    public MarketLotSizeFilter qtyExponent( Integer qtyExponent) {
    ...
    public MarketLotSizeFilter minQty( String minQty) {
        this.minQty = minQty;
        return this;
    }
    ...
    public MarketLotSizeFilter maxQty( String maxQty) {
        this.maxQty = maxQty;
        return this;
    }
    ...
    public MarketLotSizeFilter stepSize( String stepSize) {
