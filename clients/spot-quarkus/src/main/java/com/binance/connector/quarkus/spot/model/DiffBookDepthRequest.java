...
public class DiffBookDepthRequest extends BaseDTO {
     ...
     * @throws IOException if the JSON Element is invalid with respect to DiffBookDepthRequest
     */
    public static void validateJsonElement(JsonElement jsonElement) throws IOException {
        if (jsonElement == null) {
            if (!DiffBookDepthRequest.openapiRequiredFields
                    .isEmpty()) { // has required fields but JSON element is null
                throw new IllegalArgumentException(
                        String.format(
                                "The required field(s) %s in DiffBookDepthRequest is not found in"
                                        + " the empty JSON string",
                                DiffBookDepthRequest.openapiRequiredFields.toString()));
            }
        }
        ...
        for (Map.Entry<String, JsonElement> entry : entries) {
            if (!DiffBookDepthRequest.openapiFields.contains(entry.getKey())) {
                throw new IllegalArgumentException(
                        String.format(
                                "The field `%s` in the JSON string is not defined in the"
                                        + " `DiffBookDepthRequest` properties. JSON: %s",
    ...
    public static class CustomTypeAdapterFactory implements TypeAdapterFactory {
        ...
        public <T> TypeAdapter<T> create(Gson gson, TypeToken<T> type) {
            if (!DiffBookDepthRequest.class.isAssignableFrom(type.getRawType())) {
                return null; // this class only serializes 'DiffBookDepthRequest' and its subtypes
            }
            final TypeAdapter<JsonElement> elementAdapter = gson.getAdapter(JsonElement.class);
            final TypeAdapter<DiffBookDepthRequest> thisAdapter =
                    gson.getDelegateAdapter(this, TypeToken.get(DiffBookDepthRequest.class));

            return (TypeAdapter<T>)
                    new TypeAdapter<DiffBookDepthRequest>() {
                        @Override
                        ...
                        @Override
                        public DiffBookDepthRequest read(JsonReader in) throws IOException {
    ...
    /**
     * Create an instance of DiffBookDepthRequest given an JSON string
     *
     * @param jsonString JSON string
     * @return An instance of DiffBookDepthRequest
     * @throws IOException if the JSON string is invalid with respect to DiffBookDepthRequest
     */
    public static DiffBookDepthRequest fromJson(String jsonString) throws IOException {
        return JSON.getGson().fromJson(jsonString, DiffBookDepthRequest.class);
    }

    /**
     * Convert an instance of DiffBookDepthRequest to an JSON string
     *
     * @return JSON string
     */
