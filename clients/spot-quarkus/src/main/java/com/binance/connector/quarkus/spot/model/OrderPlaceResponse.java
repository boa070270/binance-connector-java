...
public class OrderPlaceResponse extends BaseDTO {
    ...
    public OrderPlaceResponse id( String id) {
        this.id = id;
        return this;
    }
    ...
    public OrderPlaceResponse status( Long status) {
        this.status = status;
        return this;
    }
    ...
    public OrderPlaceResponse result( OrderPlaceResponseResult result) {
        this.result = result;
        return this;
    }
    ...
    public void setResult( OrderPlaceResponseResult result) {
        this.result = result;
    }
