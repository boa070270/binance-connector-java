...
public class TickerResponse1Result extends BaseDTO {
    ...
    public TickerResponse1Result() {}

    public TickerResponse1Result symbol(@jakarta.annotation.Nullable String symbol) {
        this.symbol = symbol;
        return this;
    }
    ...
    public TickerResponse1Result priceChange(@jakarta.annotation.Nullable String priceChange) {
    ...
    public TickerResponse1Result priceChangePercent(
    ...
    public TickerResponse1Result weightedAvgPrice(
    ...
    public TickerResponse1Result openPrice(@jakarta.annotation.Nullable String openPrice) {
    ...
    public TickerResponse1Result highPrice(@jakarta.annotation.Nullable String highPrice) {
    ...
    public TickerResponse1Result lowPrice(@jakarta.annotation.Nullable String lowPrice) {
    ...
    public TickerResponse1Result lastPrice(@jakarta.annotation.Nullable String lastPrice) {
    ...
    public TickerResponse1Result volume(@jakarta.annotation.Nullable String volume) {
        this.volume = volume;
        return this;
    }
    ...
    public TickerResponse1Result quoteVolume(@jakarta.annotation.Nullable String quoteVolume) {
    ...
    public TickerResponse1Result openTime(@jakarta.annotation.Nullable Long openTime) {
    ...
    public TickerResponse1Result closeTime(@jakarta.annotation.Nullable Long closeTime) {
    ...
    public TickerResponse1Result firstId(@jakarta.annotation.Nullable Long firstId) {
    ...
    public TickerResponse1Result lastId(@jakarta.annotation.Nullable Long lastId) {
        this.lastId = lastId;
        return this;
    }
    ...
    public TickerResponse1Result count(@jakarta.annotation.Nullable Long count) {
        this.count = count;
        return this;
    }
    ...
    public boolean equals(Object o) {
        ...
        TickerResponse1Result tickerResponse1Result = (TickerResponse1Result) o;
        return Objects.equals(this.symbol, tickerResponse1Result.symbol)
                && Objects.equals(this.priceChange, tickerResponse1Result.priceChange)
                && Objects.equals(this.priceChangePercent, tickerResponse1Result.priceChangePercent)
                && Objects.equals(this.weightedAvgPrice, tickerResponse1Result.weightedAvgPrice)
                && Objects.equals(this.openPrice, tickerResponse1Result.openPrice)
                && Objects.equals(this.highPrice, tickerResponse1Result.highPrice)
                && Objects.equals(this.lowPrice, tickerResponse1Result.lowPrice)
                && Objects.equals(this.lastPrice, tickerResponse1Result.lastPrice)
                && Objects.equals(this.volume, tickerResponse1Result.volume)
                && Objects.equals(this.quoteVolume, tickerResponse1Result.quoteVolume)
                && Objects.equals(this.openTime, tickerResponse1Result.openTime)
                && Objects.equals(this.closeTime, tickerResponse1Result.closeTime)
                && Objects.equals(this.firstId, tickerResponse1Result.firstId)
                && Objects.equals(this.lastId, tickerResponse1Result.lastId)
                && Objects.equals(this.count, tickerResponse1Result.count);
    }
    ...
    public String toString() {
        ...
        sb.append("class TickerResponse1Result {\n");
     ...
     * @throws IOException if the JSON Element is invalid with respect to TickerResponse1Result
     */
    public static void validateJsonElement(JsonElement jsonElement) throws IOException {
        if (jsonElement == null) {
            if (!TickerResponse1Result.openapiRequiredFields
                    .isEmpty()) { // has required fields but JSON element is null
                throw new IllegalArgumentException(
                        String.format(
                                "The required field(s) %s in TickerResponse1Result is not found in"
                                        + " the empty JSON string",
                                TickerResponse1Result.openapiRequiredFields.toString()));
            }
        }
        ...
        for (Map.Entry<String, JsonElement> entry : entries) {
            if (!TickerResponse1Result.openapiFields.contains(entry.getKey())) {
                throw new IllegalArgumentException(
                        String.format(
                                "The field `%s` in the JSON string is not defined in the"
                                        + " `TickerResponse1Result` properties. JSON: %s",
    ...
    public static class CustomTypeAdapterFactory implements TypeAdapterFactory {
        ...
        public <T> TypeAdapter<T> create(Gson gson, TypeToken<T> type) {
            if (!TickerResponse1Result.class.isAssignableFrom(type.getRawType())) {
                return null; // this class only serializes 'TickerResponse1Result' and its subtypes
            }
            final TypeAdapter<JsonElement> elementAdapter = gson.getAdapter(JsonElement.class);
            final TypeAdapter<TickerResponse1Result> thisAdapter =
                    gson.getDelegateAdapter(this, TypeToken.get(TickerResponse1Result.class));

            return (TypeAdapter<T>)
                    new TypeAdapter<TickerResponse1Result>() {
                        @Override
                        public void write(JsonWriter out, TickerResponse1Result value)
                                throws IOException {
                        ...
                        @Override
                        public TickerResponse1Result read(JsonReader in) throws IOException {
    ...
    /**
     * Create an instance of TickerResponse1Result given an JSON string
     *
     * @param jsonString JSON string
     * @return An instance of TickerResponse1Result
     * @throws IOException if the JSON string is invalid with respect to TickerResponse1Result
     */
    public static TickerResponse1Result fromJson(String jsonString) throws IOException {
        return JSON.getGson().fromJson(jsonString, TickerResponse1Result.class);
    }

    /**
     * Convert an instance of TickerResponse1Result to an JSON string
     *
     * @return JSON string
     */
