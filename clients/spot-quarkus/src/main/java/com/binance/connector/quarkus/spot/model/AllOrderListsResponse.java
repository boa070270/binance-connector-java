...
public class AllOrderListsResponse extends BaseDTO {
    ...
    public AllOrderListsResponse id(@jakarta.annotation.Nullable String id) {
        this.id = id;
        return this;
    }
    ...
    public AllOrderListsResponse status(@jakarta.annotation.Nullable Long status) {
        this.status = status;
        return this;
    }
    ...
    public String toString() {
        ...
        sb.append("class AllOrderListsResponse {\n");
     ...
     * @throws IOException if the JSON Element is invalid with respect to AllOrderListsResponse
     */
    public static void validateJsonElement(JsonElement jsonElement) throws IOException {
        if (jsonElement == null) {
            if (!AllOrderListsResponse.openapiRequiredFields
                    .isEmpty()) { // has required fields but JSON element is null
                throw new IllegalArgumentException(
                        String.format(
                                "The required field(s) %s in AllOrderListsResponse is not found in"
                                        + " the empty JSON string",
                                AllOrderListsResponse.openapiRequiredFields.toString()));
            }
        }
        ...
        for (Map.Entry<String, JsonElement> entry : entries) {
            if (!AllOrderListsResponse.openapiFields.contains(entry.getKey())) {
                throw new IllegalArgumentException(
                        String.format(
                                "The field `%s` in the JSON string is not defined in the"
                                        + " `AllOrderListsResponse` properties. JSON: %s",
    ...
    public static class CustomTypeAdapterFactory implements TypeAdapterFactory {
        ...
        public <T> TypeAdapter<T> create(Gson gson, TypeToken<T> type) {
            if (!AllOrderListsResponse.class.isAssignableFrom(type.getRawType())) {
                return null; // this class only serializes 'AllOrderListsResponse' and its subtypes
            }
            final TypeAdapter<JsonElement> elementAdapter = gson.getAdapter(JsonElement.class);
            final TypeAdapter<AllOrderListsResponse> thisAdapter =
                    gson.getDelegateAdapter(this, TypeToken.get(AllOrderListsResponse.class));

            return (TypeAdapter<T>)
                    new TypeAdapter<AllOrderListsResponse>() {
                        @Override
                        ...
                        @Override
                        public AllOrderListsResponse read(JsonReader in) throws IOException {
    ...
    /**
     * Create an instance of AllOrderListsResponse given an JSON string
     *
     * @param jsonString JSON string
     * @return An instance of AllOrderListsResponse
     * @throws IOException if the JSON string is invalid with respect to AllOrderListsResponse
     */
    public static AllOrderListsResponse fromJson(String jsonString) throws IOException {
        return JSON.getGson().fromJson(jsonString, AllOrderListsResponse.class);
    }

    /**
     * Convert an instance of AllOrderListsResponse to an JSON string
     *
     * @return JSON string
     */
