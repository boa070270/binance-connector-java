...
public class OrderListCancelResponse extends BaseDTO {
    ...
    public OrderListCancelResponse id( String id) {
        this.id = id;
        return this;
    }
    ...
    public OrderListCancelResponse status( Long status) {
        this.status = status;
        return this;
    }
    ...
    public OrderListCancelResponse result(
             OrderListCancelResponseResult result) {
        this.result = result;
        return this;
    }
    ...
    public void setResult( OrderListCancelResponseResult result) {
        this.result = result;
    }
