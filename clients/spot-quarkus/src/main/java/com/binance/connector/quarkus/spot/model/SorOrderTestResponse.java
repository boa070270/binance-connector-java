...
public class SorOrderTestResponse extends BaseDTO {
    ...
    public SorOrderTestResponse id(@jakarta.annotation.Nullable String id) {
        this.id = id;
        return this;
    }
    ...
    public SorOrderTestResponse status(@jakarta.annotation.Nullable Long status) {
        this.status = status;
        return this;
    }
    ...
    public SorOrderTestResponse addRateLimitsItem(RateLimits rateLimitsItem) {
    ...
    public boolean equals(Object o) {
        ...
        return Objects.equals(this.id, sorOrderTestResponse.id)
                && Objects.equals(this.status, sorOrderTestResponse.status)
                && Objects.equals(this.result, sorOrderTestResponse.result)
                && Objects.equals(this.rateLimits, sorOrderTestResponse.rateLimits);
    }
    ...
    public static void validateJsonElement(JsonElement jsonElement) throws IOException {
        ...
        for (Map.Entry<String, JsonElement> entry : entries) {
            if (!SorOrderTestResponse.openapiFields.contains(entry.getKey())) {
                throw new IllegalArgumentException(
                        String.format(
                                "The field `%s` in the JSON string is not defined in the"
                                        + " `SorOrderTestResponse` properties. JSON: %s",
