...
public class SorOrderTestResponse extends BaseDTO {
    ...
    public SorOrderTestResponse id( String id) {
        this.id = id;
        return this;
    }
    ...
    public SorOrderTestResponse status( Long status) {
        this.status = status;
        return this;
    }
    ...
    public SorOrderTestResponse result(
             SorOrderTestResponseResult result) {
        this.result = result;
        return this;
    }
    ...
    public void setResult( SorOrderTestResponseResult result) {
        this.result = result;
    }
