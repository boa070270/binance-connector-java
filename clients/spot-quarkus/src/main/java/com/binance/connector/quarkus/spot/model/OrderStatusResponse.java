...
public class OrderStatusResponse extends BaseDTO {
    ...
    @jakarta.annotation.Nullable
    private OrderStatusResponseResult result;
    ...
    public OrderStatusResponse id(@jakarta.annotation.Nullable String id) {
        this.id = id;
        return this;
    }
    ...
    public OrderStatusResponse status(@jakarta.annotation.Nullable Long status) {
        this.status = status;
        return this;
    }
    ...
    public OrderStatusResponse result(
            @jakarta.annotation.Nullable OrderStatusResponseResult result) {
        this.result = result;
        return this;
    }
    ...
    @jakarta.annotation.Nullable
    @Valid
    public OrderStatusResponseResult getResult() {
        return result;
    }

    public void setResult(@jakarta.annotation.Nullable OrderStatusResponseResult result) {
        this.result = result;
    }

    public OrderStatusResponse rateLimits(
            @jakarta.annotation.Nullable List<@Valid RateLimits> rateLimits) {
        this.rateLimits = rateLimits;
        return this;
    }

    public OrderStatusResponse addRateLimitsItem(RateLimits rateLimitsItem) {
    ...
    public boolean equals(Object o) {
        ...
        return Objects.equals(this.id, orderStatusResponse.id)
                && Objects.equals(this.status, orderStatusResponse.status)
                && Objects.equals(this.result, orderStatusResponse.result)
                && Objects.equals(this.rateLimits, orderStatusResponse.rateLimits);
    }
    ...
    public String toUrlQueryString() {
        ...
        OrderStatusResponseResult resultValue = getResult();
        if (resultValue != null) {
    ...
    public static void validateJsonElement(JsonElement jsonElement) throws IOException {
        ...
        if (jsonObj.get("result") != null && !jsonObj.get("result").isJsonNull()) {
            OrderStatusResponseResult.validateJsonElement(jsonObj.get("result"));
        }
