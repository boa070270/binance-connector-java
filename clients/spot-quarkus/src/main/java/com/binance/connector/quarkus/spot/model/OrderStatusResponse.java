...
public class OrderStatusResponse extends BaseDTO {
    ...
    public OrderStatusResponse id( String id) {
        this.id = id;
        return this;
    }
    ...
    public OrderStatusResponse status( Long status) {
        this.status = status;
        return this;
    }
    ...
    public OrderStatusResponse result(
             OrderStatusResponseResult result) {
        this.result = result;
        return this;
    }
    ...
    public void setResult( OrderStatusResponseResult result) {
        this.result = result;
    }
