...
public class OrderCancelReplaceResponse extends BaseDTO {
    ...
    @jakarta.annotation.Nullable
    private OrderCancelReplaceResponseResult result;
    ...
    public OrderCancelReplaceResponse id(@jakarta.annotation.Nullable String id) {
        this.id = id;
        return this;
    }
    ...
    public OrderCancelReplaceResponse status(@jakarta.annotation.Nullable Long status) {
        this.status = status;
        return this;
    }
    ...
    public OrderCancelReplaceResponse result(
            @jakarta.annotation.Nullable OrderCancelReplaceResponseResult result) {
        this.result = result;
        return this;
    }
    ...
    @jakarta.annotation.Nullable
    @Valid
    public OrderCancelReplaceResponseResult getResult() {
        return result;
    }

    public void setResult(@jakarta.annotation.Nullable OrderCancelReplaceResponseResult result) {
        this.result = result;
    }
    ...
    public OrderCancelReplaceResponse addRateLimitsItem(RateLimits rateLimitsItem) {
    ...
    public boolean equals(Object o) {
        ...
        return Objects.equals(this.id, orderCancelReplaceResponse.id)
                && Objects.equals(this.status, orderCancelReplaceResponse.status)
                && Objects.equals(this.result, orderCancelReplaceResponse.result)
                && Objects.equals(this.rateLimits, orderCancelReplaceResponse.rateLimits);
    }
    ...
    public String toUrlQueryString() {
        ...
        OrderCancelReplaceResponseResult resultValue = getResult();
        if (resultValue != null) {
     ...
     * @throws IOException if the JSON Element is invalid with respect to OrderCancelReplaceResponse
     */
    public static void validateJsonElement(JsonElement jsonElement) throws IOException {
        if (jsonElement == null) {
            if (!OrderCancelReplaceResponse.openapiRequiredFields
                    .isEmpty()) { // has required fields but JSON element is null
                throw new IllegalArgumentException(
                        String.format(
                                "The required field(s) %s in OrderCancelReplaceResponse is not"
        ...
        if (jsonObj.get("result") != null && !jsonObj.get("result").isJsonNull()) {
            OrderCancelReplaceResponseResult.validateJsonElement(jsonObj.get("result"));
        }
    ...
    public static class CustomTypeAdapterFactory implements TypeAdapterFactory {
        ...
        public <T> TypeAdapter<T> create(Gson gson, TypeToken<T> type) {
            if (!OrderCancelReplaceResponse.class.isAssignableFrom(type.getRawType())) {
                return null; // this class only serializes 'OrderCancelReplaceResponse' and its
                // subtypes
            }
            final TypeAdapter<JsonElement> elementAdapter = gson.getAdapter(JsonElement.class);
            final TypeAdapter<OrderCancelReplaceResponse> thisAdapter =
                    gson.getDelegateAdapter(this, TypeToken.get(OrderCancelReplaceResponse.class));

            return (TypeAdapter<T>)
                    new TypeAdapter<OrderCancelReplaceResponse>() {
                        @Override
                        ...
                        @Override
                        public OrderCancelReplaceResponse read(JsonReader in) throws IOException {
    ...
    /**
     * Create an instance of OrderCancelReplaceResponse given an JSON string
     *
     * @param jsonString JSON string
     * @return An instance of OrderCancelReplaceResponse
     * @throws IOException if the JSON string is invalid with respect to OrderCancelReplaceResponse
     */
    public static OrderCancelReplaceResponse fromJson(String jsonString) throws IOException {
        return JSON.getGson().fromJson(jsonString, OrderCancelReplaceResponse.class);
    }

    /**
     * Convert an instance of OrderCancelReplaceResponse to an JSON string
     *
     * @return JSON string
     */
