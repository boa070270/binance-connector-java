...
public class OrderCancelReplaceResponse extends BaseDTO {
    ...
    public OrderCancelReplaceResponse id( String id) {
        this.id = id;
        return this;
    }
    ...
    public OrderCancelReplaceResponse status( Long status) {
        this.status = status;
        return this;
    }
    ...
    public OrderCancelReplaceResponse result(
             OrderCancelReplaceResponseResult result) {
        this.result = result;
        return this;
    }
    ...
    public void setResult( OrderCancelReplaceResponseResult result) {
        this.result = result;
    }
