...
public class OrderListPlaceOtoResponse extends BaseDTO {
    ...
    public OrderListPlaceOtoResponse id( String id) {
        this.id = id;
        return this;
    }
    ...
    public OrderListPlaceOtoResponse status( Long status) {
        this.status = status;
        return this;
    }
    ...
    public OrderListPlaceOtoResponse result(
             OrderListPlaceOtoResponseResult result) {
        this.result = result;
        return this;
    }
    ...
    public void setResult( OrderListPlaceOtoResponseResult result) {
        this.result = result;
    }
