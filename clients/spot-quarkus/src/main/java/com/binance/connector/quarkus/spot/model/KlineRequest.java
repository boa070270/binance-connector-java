...
public class KlineRequest extends BaseDTO {
     ...
     * @throws IOException if the JSON Element is invalid with respect to KlineRequest
     */
    public static void validateJsonElement(JsonElement jsonElement) throws IOException {
        if (jsonElement == null) {
            if (!KlineRequest.openapiRequiredFields
                    .isEmpty()) { // has required fields but JSON element is null
                throw new IllegalArgumentException(
                        String.format(
                                "The required field(s) %s in KlineRequest is not found in the empty"
                                        + " JSON string",
                                KlineRequest.openapiRequiredFields.toString()));
            }
        }
        ...
        for (Map.Entry<String, JsonElement> entry : entries) {
            if (!KlineRequest.openapiFields.contains(entry.getKey())) {
                throw new IllegalArgumentException(
                        String.format(
                                "The field `%s` in the JSON string is not defined in the"
                                        + " `KlineRequest` properties. JSON: %s",
    ...
    public static class CustomTypeAdapterFactory implements TypeAdapterFactory {
        ...
        public <T> TypeAdapter<T> create(Gson gson, TypeToken<T> type) {
            if (!KlineRequest.class.isAssignableFrom(type.getRawType())) {
                return null; // this class only serializes 'KlineRequest' and its subtypes
            }
            final TypeAdapter<JsonElement> elementAdapter = gson.getAdapter(JsonElement.class);
            final TypeAdapter<KlineRequest> thisAdapter =
                    gson.getDelegateAdapter(this, TypeToken.get(KlineRequest.class));
            ...
            return (TypeAdapter<T>)
                    new TypeAdapter<KlineRequest>() {
                        ...
                        @Override
                        public KlineRequest read(JsonReader in) throws IOException {
    ...
    /**
     * Create an instance of KlineRequest given an JSON string
     *
     * @param jsonString JSON string
     * @return An instance of KlineRequest
     * @throws IOException if the JSON string is invalid with respect to KlineRequest
     */
    public static KlineRequest fromJson(String jsonString) throws IOException {
        return JSON.getGson().fromJson(jsonString, KlineRequest.class);
    }

    /**
     * Convert an instance of KlineRequest to an JSON string
     *
     * @return JSON string
     */
