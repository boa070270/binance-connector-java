...
public class MyFiltersResponse extends BaseDTO {
    ...
    public MyFiltersResponse id( String id) {
        this.id = id;
        return this;
    }
    ...
    public MyFiltersResponse status( Long status) {
        this.status = status;
        return this;
    }
    ...
    public MyFiltersResponse result( MyFiltersResponseResult result) {
        this.result = result;
        return this;
    }
    ...
    public void setResult( MyFiltersResponseResult result) {
        this.result = result;
    }
