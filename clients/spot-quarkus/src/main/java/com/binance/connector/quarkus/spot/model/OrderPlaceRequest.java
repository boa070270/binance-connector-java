...
public class OrderPlaceRequest extends BaseDTO {
    ...
    public OrderPlaceRequest symbol(@jakarta.annotation.Nonnull String symbol) {
        this.symbol = symbol;
        return this;
    }
    ...
    public OrderPlaceRequest side(@jakarta.annotation.Nonnull Side side) {
        this.side = side;
        return this;
    }
    ...
    public OrderPlaceRequest type(@jakarta.annotation.Nonnull OrderType type) {
        this.type = type;
        return this;
    }
    ...
    public OrderPlaceRequest timeInForce(@jakarta.annotation.Nullable TimeInForce timeInForce) {
    ...
    public OrderPlaceRequest price(@jakarta.annotation.Nullable Double price) {
        this.price = price;
        return this;
    }
    ...
    public OrderPlaceRequest quantity(@jakarta.annotation.Nullable Double quantity) {
    ...
    public OrderPlaceRequest quoteOrderQty(@jakarta.annotation.Nullable Double quoteOrderQty) {
    ...
    public OrderPlaceRequest newClientOrderId(
    ...
    public OrderPlaceRequest newOrderRespType(
    ...
    public OrderPlaceRequest stopPrice(@jakarta.annotation.Nullable Double stopPrice) {
    ...
    public OrderPlaceRequest trailingDelta(@jakarta.annotation.Nullable Integer trailingDelta) {
    ...
    public OrderPlaceRequest icebergQty(@jakarta.annotation.Nullable Double icebergQty) {
    ...
    public OrderPlaceRequest strategyId(@jakarta.annotation.Nullable Long strategyId) {
    ...
    public OrderPlaceRequest strategyType(@jakarta.annotation.Nullable Integer strategyType) {
    ...
    public OrderPlaceRequest selfTradePreventionMode(
    ...
    public OrderPlaceRequest pegPriceType(@jakarta.annotation.Nullable PegPriceType pegPriceType) {
    ...
    public OrderPlaceRequest pegOffsetValue(@jakarta.annotation.Nullable Integer pegOffsetValue) {
    ...
    public OrderPlaceRequest pegOffsetType(
    ...
    public OrderPlaceRequest recvWindow(@jakarta.annotation.Nullable Double recvWindow) {
    ...
    public boolean equals(Object o) {
        ...
        OrderPlaceRequest orderPlaceRequest = (OrderPlaceRequest) o;
        return Objects.equals(this.symbol, orderPlaceRequest.symbol)
                && Objects.equals(this.side, orderPlaceRequest.side)
                && Objects.equals(this.type, orderPlaceRequest.type)
                && Objects.equals(this.timeInForce, orderPlaceRequest.timeInForce)
                && Objects.equals(this.price, orderPlaceRequest.price)
                && Objects.equals(this.quantity, orderPlaceRequest.quantity)
                && Objects.equals(this.quoteOrderQty, orderPlaceRequest.quoteOrderQty)
                && Objects.equals(this.newClientOrderId, orderPlaceRequest.newClientOrderId)
                && Objects.equals(this.newOrderRespType, orderPlaceRequest.newOrderRespType)
                && Objects.equals(this.stopPrice, orderPlaceRequest.stopPrice)
                && Objects.equals(this.trailingDelta, orderPlaceRequest.trailingDelta)
                && Objects.equals(this.icebergQty, orderPlaceRequest.icebergQty)
                && Objects.equals(this.strategyId, orderPlaceRequest.strategyId)
                && Objects.equals(this.strategyType, orderPlaceRequest.strategyType)
                && Objects.equals(
                        this.selfTradePreventionMode, orderPlaceRequest.selfTradePreventionMode)
                && Objects.equals(this.pegPriceType, orderPlaceRequest.pegPriceType)
                && Objects.equals(this.pegOffsetValue, orderPlaceRequest.pegOffsetValue)
                && Objects.equals(this.pegOffsetType, orderPlaceRequest.pegOffsetType)
                && Objects.equals(this.recvWindow, orderPlaceRequest.recvWindow);
    }
    ...
    public String toString() {
        ...
        sb.append("class OrderPlaceRequest {\n");
     ...
     * @throws IOException if the JSON Element is invalid with respect to OrderPlaceRequest
     */
    public static void validateJsonElement(JsonElement jsonElement) throws IOException {
        if (jsonElement == null) {
            if (!OrderPlaceRequest.openapiRequiredFields
                    .isEmpty()) { // has required fields but JSON element is null
                throw new IllegalArgumentException(
                        String.format(
                                "The required field(s) %s in OrderPlaceRequest is not found in the"
                                        + " empty JSON string",
                                OrderPlaceRequest.openapiRequiredFields.toString()));
            }
        }
        ...
        for (Map.Entry<String, JsonElement> entry : entries) {
            if (!OrderPlaceRequest.openapiFields.contains(entry.getKey())) {
                throw new IllegalArgumentException(
                        String.format(
                                "The field `%s` in the JSON string is not defined in the"
                                        + " `OrderPlaceRequest` properties. JSON: %s",
                                entry.getKey(), jsonElement.toString()));
            }
        }

        // check to make sure all required properties/fields are present in the JSON string
        for (String requiredField : OrderPlaceRequest.openapiRequiredFields) {
    ...
    public static class CustomTypeAdapterFactory implements TypeAdapterFactory {
        ...
        public <T> TypeAdapter<T> create(Gson gson, TypeToken<T> type) {
            if (!OrderPlaceRequest.class.isAssignableFrom(type.getRawType())) {
                return null; // this class only serializes 'OrderPlaceRequest' and its subtypes
            }
            final TypeAdapter<JsonElement> elementAdapter = gson.getAdapter(JsonElement.class);
            final TypeAdapter<OrderPlaceRequest> thisAdapter =
                    gson.getDelegateAdapter(this, TypeToken.get(OrderPlaceRequest.class));

            return (TypeAdapter<T>)
                    new TypeAdapter<OrderPlaceRequest>() {
                        @Override
                        public void write(JsonWriter out, OrderPlaceRequest value)
                                throws IOException {
                        ...
                        @Override
                        public OrderPlaceRequest read(JsonReader in) throws IOException {
    ...
    /**
     * Create an instance of OrderPlaceRequest given an JSON string
     *
     * @param jsonString JSON string
     * @return An instance of OrderPlaceRequest
     * @throws IOException if the JSON string is invalid with respect to OrderPlaceRequest
     */
    public static OrderPlaceRequest fromJson(String jsonString) throws IOException {
        return JSON.getGson().fromJson(jsonString, OrderPlaceRequest.class);
    }

    /**
     * Convert an instance of OrderPlaceRequest to an JSON string
     *
     * @return JSON string
     */
