...
public class TickerTradingDayResponse extends BaseDTO {
    ...
    public TickerTradingDayResponse addRateLimitsItem(RateLimits rateLimitsItem) {
    ...
    public static class CustomTypeAdapterFactory implements TypeAdapterFactory {
        ...
        public <T> TypeAdapter<T> create(Gson gson, TypeToken<T> type) {
            if (!TickerTradingDayResponse.class.isAssignableFrom(type.getRawType())) {
                return null; // this class only serializes 'TickerTradingDayResponse' and its
                // subtypes
            }
    ...
    /**
     * Create an instance of TickerTradingDayResponse given an JSON string
     *
     * @param jsonString JSON string
     * @return An instance of TickerTradingDayResponse
     * @throws IOException if the JSON string is invalid with respect to TickerTradingDayResponse
     */
    public static TickerTradingDayResponse fromJson(String jsonString) throws IOException {
        return JSON.getGson().fromJson(jsonString, TickerTradingDayResponse.class);
    }

    /**
     * Convert an instance of TickerTradingDayResponse to an JSON string
     *
     * @return JSON string
     */
