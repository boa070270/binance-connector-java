...
public class AllOrdersResponse extends BaseDTO {
    ...
    @jakarta.annotation.Nullable
    private List<@Valid AllOrdersResponseResultInner> result;
    ...
    public AllOrdersResponse id(@jakarta.annotation.Nullable String id) {
        this.id = id;
        return this;
    }
    ...
    public AllOrdersResponse status(@jakarta.annotation.Nullable Long status) {
        this.status = status;
        return this;
    }
    ...
    public AllOrdersResponse result(
            @jakarta.annotation.Nullable List<@Valid AllOrdersResponseResultInner> result) {
        this.result = result;
        return this;
    }
    ...
    @jakarta.annotation.Nullable
    @Valid
    public List<@Valid AllOrdersResponseResultInner> getResult() {
        return result;
    }
    ...
    public String toString() {
        ...
        sb.append("class AllOrdersResponse {\n");
    ...
    public String toUrlQueryString() {
        ...
        List<@Valid AllOrdersResponseResultInner> resultValue = getResult();
        if (resultValue != null) {
        ...
        if (jsonElement == null) {
            if (!AllOrdersResponse.openapiRequiredFields
                ...
                throw new IllegalArgumentException(
                        String.format(
                                "The required field(s) %s in AllOrdersResponse is not found in the"
                                        + " empty JSON string",
    ...
    public static class CustomTypeAdapterFactory implements TypeAdapterFactory {
        ...
        public <T> TypeAdapter<T> create(Gson gson, TypeToken<T> type) {
            if (!AllOrdersResponse.class.isAssignableFrom(type.getRawType())) {
                return null; // this class only serializes 'AllOrdersResponse' and its subtypes
            }
            final TypeAdapter<JsonElement> elementAdapter = gson.getAdapter(JsonElement.class);
            final TypeAdapter<AllOrdersResponse> thisAdapter =
                    gson.getDelegateAdapter(this, TypeToken.get(AllOrdersResponse.class));

            return (TypeAdapter<T>)
                    new TypeAdapter<AllOrdersResponse>() {
                        @Override
                        public void write(JsonWriter out, AllOrdersResponse value)
                                throws IOException {
                        ...
                        @Override
                        public AllOrdersResponse read(JsonReader in) throws IOException {
    ...
    /**
     * Create an instance of AllOrdersResponse given an JSON string
     *
     * @param jsonString JSON string
     * @return An instance of AllOrdersResponse
     * @throws IOException if the JSON string is invalid with respect to AllOrdersResponse
     */
    public static AllOrdersResponse fromJson(String jsonString) throws IOException {
        return JSON.getGson().fromJson(jsonString, AllOrdersResponse.class);
    }

    /**
     * Convert an instance of AllOrdersResponse to an JSON string
     *
     * @return JSON string
     */
