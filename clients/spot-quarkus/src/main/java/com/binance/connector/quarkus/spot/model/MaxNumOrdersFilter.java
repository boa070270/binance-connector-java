...
public class MaxNumOrdersFilter extends BaseDTO {
    ...
    public MaxNumOrdersFilter filterType( String filterType) {
    ...
    public MaxNumOrdersFilter maxNumOrders( Long maxNumOrders) {
