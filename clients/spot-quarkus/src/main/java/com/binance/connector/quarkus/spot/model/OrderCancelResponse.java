...
public class OrderCancelResponse extends BaseDTO {
    ...
    public OrderCancelResponse id(@jakarta.annotation.Nullable String id) {
        this.id = id;
        return this;
    }
    ...
    public OrderCancelResponse status(@jakarta.annotation.Nullable Long status) {
        this.status = status;
        return this;
    }
    ...
    public OrderCancelResponse result(
            @jakarta.annotation.Nullable OrderCancelResponseResult result) {
        this.result = result;
        return this;
    }
    ...
    public void setResult(@jakarta.annotation.Nullable OrderCancelResponseResult result) {
        this.result = result;
    }
    ...
    public static void validateJsonElement(JsonElement jsonElement) throws IOException {
        if (jsonElement == null) {
            if (!OrderCancelResponse.openapiRequiredFields
                    .isEmpty()) { // has required fields but JSON element is null
                throw new IllegalArgumentException(
                        String.format(
                                "The required field(s) %s in OrderCancelResponse is not found in"
                                        + " the empty JSON string",
                                OrderCancelResponse.openapiRequiredFields.toString()));
            }
        }
                ...
                throw new IllegalArgumentException(
                        String.format(
                                "The field `%s` in the JSON string is not defined in the"
                                        + " `OrderCancelResponse` properties. JSON: %s",
        ...
        if (jsonObj.get("result") != null && !jsonObj.get("result").isJsonNull()) {
            OrderCancelResponseResult.validateJsonElement(jsonObj.get("result"));
        }
    ...
    public static class CustomTypeAdapterFactory implements TypeAdapterFactory {
        ...
        public <T> TypeAdapter<T> create(Gson gson, TypeToken<T> type) {
            ...
            return (TypeAdapter<T>)
                    new TypeAdapter<OrderCancelResponse>() {
                        @Override
                        public void write(JsonWriter out, OrderCancelResponse value)
                                throws IOException {
