...
public class Ticker24hrResponse1 extends BaseDTO {
    ...
    public Ticker24hrResponse1 id( String id) {
        this.id = id;
        return this;
    }
    ...
    public Ticker24hrResponse1 status( Long status) {
        this.status = status;
        return this;
    }
    ...
    public Ticker24hrResponse1 result(
             Ticker24hrResponse1Result result) {
        this.result = result;
        return this;
    }
    ...
    public void setResult( Ticker24hrResponse1Result result) {
        this.result = result;
    }
