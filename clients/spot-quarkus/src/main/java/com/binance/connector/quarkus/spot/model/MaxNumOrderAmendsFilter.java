...
public class MaxNumOrderAmendsFilter extends BaseDTO {
    ...
    @JsonProperty(SERIALIZED_NAME_MAX_NUM_ORDER_AMENDS)
    
    private Long maxNumOrderAmends;

    public MaxNumOrderAmendsFilter() {}

    public MaxNumOrderAmendsFilter filterType( String filterType) {
    ...
    public void setMaxNumOrderAmends( Long maxNumOrderAmends) {
        this.maxNumOrderAmends = maxNumOrderAmends;
    }
