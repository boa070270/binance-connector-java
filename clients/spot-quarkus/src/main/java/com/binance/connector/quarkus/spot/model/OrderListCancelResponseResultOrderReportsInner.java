...
public class OrderListCancelResponseResultOrderReportsInner extends BaseDTO {
    ...
    public static void validateJsonElement(JsonElement jsonElement) throws IOException {
        if (jsonElement == null) {
            if (!OrderListCancelResponseResultOrderReportsInner.openapiRequiredFields
                    .isEmpty()) { // has required fields but JSON element is null
                throw new IllegalArgumentException(
                        String.format(
                                "The required field(s) %s in"
                                    + " OrderListCancelResponseResultOrderReportsInner is not found"
                                    + " in the empty JSON string",
                                OrderListCancelResponseResultOrderReportsInner.openapiRequiredFields
                                        .toString()));
            }
        }
        ...
        for (Map.Entry<String, JsonElement> entry : entries) {
            if (!OrderListCancelResponseResultOrderReportsInner.openapiFields.contains(
                    entry.getKey())) {
                throw new IllegalArgumentException(
                        String.format(
    ...
    public static class CustomTypeAdapterFactory implements TypeAdapterFactory {
        ...
        public <T> TypeAdapter<T> create(Gson gson, TypeToken<T> type) {
            if (!OrderListCancelResponseResultOrderReportsInner.class.isAssignableFrom(
                    type.getRawType())) {
                return null; // this class only serializes
                // 'OrderListCancelResponseResultOrderReportsInner' and its subtypes
            }
            final TypeAdapter<JsonElement> elementAdapter = gson.getAdapter(JsonElement.class);
            final TypeAdapter<OrderListCancelResponseResultOrderReportsInner> thisAdapter =
                    gson.getDelegateAdapter(
                            this,
                            TypeToken.get(OrderListCancelResponseResultOrderReportsInner.class));

            return (TypeAdapter<T>)
                    new TypeAdapter<OrderListCancelResponseResultOrderReportsInner>() {
                        @Override
                        public void write(
                                JsonWriter out,
                                OrderListCancelResponseResultOrderReportsInner value)
                                throws IOException {
                        ...
                        @Override
                        public OrderListCancelResponseResultOrderReportsInner read(JsonReader in)
                                throws IOException {
    ...
    /**
     * Create an instance of OrderListCancelResponseResultOrderReportsInner given an JSON string
     *
     * @param jsonString JSON string
     * @return An instance of OrderListCancelResponseResultOrderReportsInner
     * @throws IOException if the JSON string is invalid with respect to
     *     OrderListCancelResponseResultOrderReportsInner
     */
    public static OrderListCancelResponseResultOrderReportsInner fromJson(String jsonString)
            throws IOException {
        return JSON.getGson()
                .fromJson(jsonString, OrderListCancelResponseResultOrderReportsInner.class);
    }

    /**
     * Convert an instance of OrderListCancelResponseResultOrderReportsInner to an JSON string
     *
     * @return JSON string
     */
