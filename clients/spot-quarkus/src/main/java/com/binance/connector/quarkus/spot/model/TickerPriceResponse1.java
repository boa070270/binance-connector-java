...
public class TickerPriceResponse1 extends BaseDTO {
    ...
    public TickerPriceResponse1 id( String id) {
        this.id = id;
        return this;
    }
    ...
    public TickerPriceResponse1 status( Long status) {
        this.status = status;
        return this;
    }
    ...
    public TickerPriceResponse1 result(
             TickerPriceResponse1Result result) {
        this.result = result;
        return this;
    }
    ...
    public void setResult( TickerPriceResponse1Result result) {
        this.result = result;
    }
