...
public class SessionLogoutResponse extends BaseDTO {
    ...
    public SessionLogoutResponse id( String id) {
        this.id = id;
        return this;
    }
    ...
    public SessionLogoutResponse status( Long status) {
        this.status = status;
        return this;
    }
    ...
    public SessionLogoutResponse result(
             SessionLogoutResponseResult result) {
        this.result = result;
        return this;
    }
    ...
    public void setResult( SessionLogoutResponseResult result) {
        this.result = result;
    }
