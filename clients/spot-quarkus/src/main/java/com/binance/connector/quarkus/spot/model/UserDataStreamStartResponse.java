...
public class UserDataStreamStartResponse extends BaseDTO {
    ...
    public UserDataStreamStartResponse id( String id) {
        this.id = id;
        return this;
    }
    ...
    public UserDataStreamStartResponse status( Long status) {
        this.status = status;
        return this;
    }
    ...
    public UserDataStreamStartResponse result(
             UserDataStreamStartResponseResult result) {
        this.result = result;
        return this;
    }
    ...
    public void setResult( UserDataStreamStartResponseResult result) {
        this.result = result;
    }
