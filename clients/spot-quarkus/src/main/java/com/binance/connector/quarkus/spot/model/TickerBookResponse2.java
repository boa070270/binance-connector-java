...
public class TickerBookResponse2 extends BaseDTO {
    ...
    private List<TickerBookResponse1Result> result;
    ...
    public TickerBookResponse2 id( String id) {
        this.id = id;
        return this;
    }
    ...
    public TickerBookResponse2 status( Long status) {
        this.status = status;
        return this;
    }
    ...
    public TickerBookResponse2 result(
             List<TickerBookResponse1Result> result) {
        this.result = result;
        return this;
    }
    ...
    public List<TickerBookResponse1Result> getResult() {
        return result;
    }
    ...
    public String toUrlQueryString() {
        ...
        List<TickerBookResponse1Result> resultValue = getResult();
        if (resultValue != null) {
