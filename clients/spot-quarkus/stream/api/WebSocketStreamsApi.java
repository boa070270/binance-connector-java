...
public class WebSocketStreamsApi {
    ...
    public StreamBlockingQueueWrapper<TickerResponseStream> ticker(TickerRequestStream tickerRequest)
        ...
        TypeToken<TickerResponseStream> typeToken = new TypeToken<TickerResponseStream>() {};

        return new StreamBlockingQueueWrapper<>(queue, typeToken);
    }

    public StreamBlockingQueue<String> tickerRaw(TickerRequestStream tickerRequest) throws ApiException {
    ...
    @SuppressWarnings("rawtypes")
    private void tickerValidateBeforeCall(TickerRequestStream tickerRequest) throws ApiException {
        try {
            Validator validator =
                    Validation.byDefaultProvider()
                            .configure()
            ...
            Set<ConstraintViolation<TickerRequestStream>> violations = validator.validate(tickerRequest);
